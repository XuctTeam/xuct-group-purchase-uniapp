  ...
  setup(__props, { emit: emits }) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        J: common_vendor.sr(aniplay, "158b0a7a-0", {
          "k": "aniplay"
        }),
        ...
        M: `${props.margin[0] + props.unit} ${props.margin[0] + props.unit}`
      }) : {});
    };
  }
});
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "E:/workspace_xuct/xuct-group-purchase/xuct-group-purchase-uniapp/src/tmui/components/tm-image/tm-image.vue"]]);
