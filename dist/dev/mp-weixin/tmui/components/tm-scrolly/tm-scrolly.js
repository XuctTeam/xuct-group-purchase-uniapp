...
const _sfc_main = /* @__PURE__ */ common_vendor.defineComponent({
  __name: "tm-scrolly",
  props: {
    ...tmui_components_tmScrolly_propsdetail.propsdetail
  },
  emits: [
    "bottom",
    "change",
  ...
  setup(__props, { emit: emits }) {
    ...
    common_vendor.onMounted(() => {
      ...
      common_vendor.nextTick(() => setDefault());
    });
    function setDefault() {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        c: common_vendor.p({
          color: "grey",
          _class: "pl-16",
          label: _ctx.loadingTexts[refreshStatus.value]
        })
      } : {}, {
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-a5038a4a"], ["__file", "E:/workspace_xuct/xuct-group-purchase/xuct-group-purchase-uniapp/src/tmui/components/tm-scrolly/tm-scrolly.vue"]]);
